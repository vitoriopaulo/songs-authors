...
const getOneSongSuccess = function (data) {
  ...
  console.log(store)
  $('#message').show().text('Sucessfully get song.').fadeOut(5000)
}

const getOneSongFailure = function (error) {
  console.error(error)
  $('.my-input').val("")
  $('#message').show().text('Error on getting song. Try again.').fadeOut(5000)
}
...
const addSongSuccess = function (data) {
  ...
  $('.my-input').val("")
  $('#message').show().text('Song sucessfully added.').fadeOut(5000)
}
...
const addSongFailure = function (error) {
  ...
  $('.my-input').val("")
  $('#message').show().text('Failure on trying to add song to database. Try again.').fadeOut(5000)
}

const updateSongSuccess = function (data) {
  console.log(data)
  $('.my-input').val("")
  $('#message').show().text('Song updated succesfully.').fadeOut(5000)
}

const updateSongFailure = function (data) {
  console.log(data)
  $('.my-input').val("")
  $('#message').show().text('Failure on updating song.').fadeOut(5000)
}
...
const deleteSongSuccess = function (data) {
  ...
  $('#message').show().text('Song successfully deleted.').fadeOut(5000)
}
...
const deleteSongFailure = function (error) {
  ...
  $('#message').show().text('Failure deleting song.').fadeOut(5000)
}
