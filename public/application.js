...
// https://git.heroku.com/songs-and-authors.git
...
var songsEvents = __webpack_require__(13);
...
var onGetAllSongs = function onGetAllSongs(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.getAllSongs(data).then(ui.getAllSongsSuccess).catch(ui.getAllSongsFailure);
};

var onGetOneSong = function onGetOneSong(event) {
  var data = getFormFields(this);
  // console.log(data.song)
  event.preventDefault();
  api.getOneSong(data).then(ui.getOneSongSuccess).catch(ui.getOneSongFailure);
};
...
var getAllSongs = function getAllSongs(data) {
  return $.ajax({
...
var getOneSong = function getOneSong(data) {
...
var getAllSongsSuccess = function getAllSongsSuccess(data) {
  ...
  // $('.my-input').val("")
  $('#message').show().text('Have songs? Songs will be rendered. No songs? Please add songs.').delay(5000).fadeOut(7000);
};

var getAllSongsFailure = function getAllSongsFailure(error) {
  console.error(error);
...
var getOneSongSuccess = function getOneSongSuccess(data) {
...
var getOneSongFailure = function getOneSongFailure(error) {
  console.error(error);
  $('.my-input').val("");
...
var deleteSongSuccess = function deleteSongSuccess(data) {
  // console.log(data.song)
  $('.my-input').val("");
  // console.log('Signed out succesfully!')
...
module.exports = {
  getAllSongsSuccess: getAllSongsSuccess,
  getAllSongsFailure: getAllSongsFailure,
  getOneSongSuccess: getOneSongSuccess,
  getOneSongFailure: getOneSongFailure,
